...
const { updatePassword, updateNickname, initSetup, getMyInfo, updateMyInfo } = require("../controllers/userController");
...
router.get("/me", getMyInfo);       // 내 정보 불러오기
router.patch("/info", updateMyInfo); // 내 정보 전체 수정
