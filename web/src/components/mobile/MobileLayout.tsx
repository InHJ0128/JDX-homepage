  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#fff' }}>
      ...
      >
        ...
        {/* ✅ 우측 공간 맞춤용 빈 div를 홈 버튼으로 교체 */}
        <Link
          to="/m"
          aria-label={language === 'ko' ? '홈으로' : 'ホームへ'}
          style={{
      ...
      >
        ...
        <div style={{ padding: '10px 10px', borderBottom: '1px solid #f4f4f4' }}>
          {!isLoggedIn ? (
            ...
            <div style={{ display:'flex', flexDirection:'column', gap: 8 }}>
              <Link to="/m/mypage" onClick={close} style={{ ...linkStyle, padding: 0, fontWeight: 600 }}>
        ...
        <ul style={{ listStyle: 'none', margin: 0, padding: 8 }}>
          ...
          <MobileNavItem to="/m/apply"     label={LABELS.apply[language]}      onClick={close} />
        </ul>
