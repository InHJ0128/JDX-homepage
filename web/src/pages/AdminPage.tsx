...
import AdminAiDashboard from './admin/AdminAiDashboard';
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-100 p-4 border-r">
          ...
          <ul className="space-y-2">
            ...
            <li><button onClick={() => setSelectedMenu("applications")} className="hover:underline">📨 {language === "ko" ? "지원서" : "応募"}</button></li>
            <li><button onClick={() => setSelectedMenu('ai')} className="hover:underline">🤖 {language === "ko" ? "AI 관리" : "AI管理"}</button></li>
          </ul>
        </aside>
